...
extension FZTableViewManager {
    ...
    internal func checkDataSourceResponds(to selector: Selector) -> Bool {
        ...
        switch optionalEnum {
            case .numberOfSections:
                return dataSourceDecorator?.tableViewNumberOfSectionsClosure != nil
            case .titleForHeaderInSection:
                return dataSourceDecorator?.tableViewTitleForHeaderInSectionClosure != nil
            case .titleForFooterInSection:
                return dataSourceDecorator?.tableViewTitleForFooterInSectionClosure != nil
            case .canEditRowAtIndexPath:
                return dataSourceDecorator?.tableViewCanEditRowAtIndexPathClosure != nil
            case .canMoveRowAtIndexPath:
                return dataSourceDecorator?.tableViewCanMoveRowAtIndexPathClosure != nil
            case .sectionIndexTitles:
                return dataSourceDecorator?.tableViewSectionIndexTitlesClosure != nil
            case .sectionForSectionIndexTitle:
                return dataSourceDecorator?.tableViewSectionForSectionIndexTitleClosure != nil
            case .commitEditingStyle:
                return dataSourceDecorator?.tableViewCommitEditingStyleClosure != nil
            case .moveRowAtSourceIndexPath:
                return dataSourceDecorator?.tableViewMoveRowAtSourceIndexPathClosure != nil
            @unknown default:
                return false
        }
    }
